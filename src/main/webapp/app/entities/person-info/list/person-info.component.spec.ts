...
describe('PersonInfo Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'person-info', component: PersonInfoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.personInfos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to personInfoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPersonInfoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPersonInfoIdentifier).toHaveBeenCalledWith(entity);
